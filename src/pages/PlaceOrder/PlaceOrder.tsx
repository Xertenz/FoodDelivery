...
export default function PlaceOrder() {
  ...
  return (
    <form className="place-order container mx-auto flex flex-col items-center sm:flex-row sm:justify-between sm:items-start gap-12 py-12 px-8 sm:px-0">
      ...
      <div className="place-order-right w-100 max-w-full">
